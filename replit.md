...
- **Debug logging**: `[TOWER_CALL] url=<...> status=<HTTP>` for every Tower HTTP call. `[TOWER_VERDICT] verdict=<V> delivered=<N> requested=<N> confidence=<N>` for every verdict received.
