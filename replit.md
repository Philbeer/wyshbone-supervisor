...
- **Learning Layer v1**: A deterministic policy engine for pre-plan constraint application, using `telemetry_events`, `policy_versions`, and `policy_applications` tables.
