...
- `sup001_plannerEnabled`: ✅ Lead generation plan object system (`server/types/lead-gen-plan.ts`)
- `sup002_executorEnabled`: ✅ Plan executor for task processing (`server/supervisor.ts`)
