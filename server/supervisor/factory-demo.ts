    ...
    if (towerAction === 'change_plan' && i < steps.length - 1) {
      ...
      await createArtefact({
        ...
        payload: {
          ...
          machine_used_from: previousMachine,
          machine_used_to: currentMachine,
          machine_label_from: previousMachineLabel,
          machine_label_to: machineLabel(),
          machine_id_from: (previousMachine === 'primary' ? machines.primary : machines.alternate).id,
          machine_id_to: currentMachineProfile().id,
